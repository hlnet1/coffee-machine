...
public class CoffeeMachineIntegrationTest {
    ...
    void completeVendingFlow_ShouldWorkSuccessfully() throws Exception {
        ...
        mockMvc.perform(post("/api/vending/insert-coins")
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        MvcResult totalResult = mockMvc.perform(get("/api/vending/coins/inserted-sum"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    void returnCoins_ShouldReturnAllInsertedCoins() throws Exception {
        ...
        MvcResult returnResult = mockMvc.perform(post("/api/vending/coins/return-inserted"))
                .andExpect(status().isOk())
                .andReturn();
